        ...
        <div className='flex justify-between items-center mx-auto container'>
            ...
            <ul className='hidden md:flex space-x-6'>
              <li className={styles.link1}>
                <a className={styles.link2} href='#home'>Home</a>
              </li>
              <li className={styles.link1} >
                <a className={styles.link2} href='#about'>About</a>
              </li>
              <li className={styles.link1} >
                <a className={styles.link2} href='#contact'>Contact</a>
              </li>
           </ul>
        ...
        {isMenuOpen && (
          <div className='md:hidden absolute top-full left-0 right-0 bg-teal-700/95 backdrop-blur-md border-t border-white/20 z-50'>
            <ul className='flex flex-col items-center py-4 space-y-4'>
              <li className={styles.link1}>
                <a className={styles.link2} href='#home' onClick={() => setIsMenuOpen(false)}>Home</a>
              </li>
              <li className={styles.link1} >
                <a className={styles.link2} href='#about' onClick={() => setIsMenuOpen(false)}>About</a>
              </li>
              <li className={styles.link1} >
                <a className={styles.link2} href='#contact' onClick={() => setIsMenuOpen(false)}>Contact</a>
              </li>
            </ul>
          </div>
        )}
